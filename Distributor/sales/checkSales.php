...
<head>
    ...
    <title>Sales Invoice | Sales | Distributor</title>
                        ...
                        if($count3>0){
                            ...
                            if($exec4){
                                ...
                                if($exec5){
                                    ...
                                    $newItemId = $oldItem.'-'.$buyercompanyId.'-'.$quantity;
                                    $qry6 = "INSERT INTO `".$buyerDb."`.`tbl_pendingStock` VALUES(null,'$newItemId','$medicineName','$batchNumber','$strength','$dosageForm','$productionDate','$expiryDate','$MAId','$quantity')";
                                    $cony = mysqli_connect('localhost','root','',$buyerDb);
                                    $exec6 = mysqli_query($cony,$qry6);
                                    if($exec6){
                                        $qry7 = "INSERT INTO tbl_pastSales VALUES(null,'$newItemId','$MAId','$medicineName','$batchNumber','$strength','$dosageForm',CURRENT_DATE,'$buyerCompanyName','$buyercompanyId','$quantity')";
                                        ...
                                        if($exec7){
                                            ...
                                            if($exec8){
                                                ...
                                                $qry9 = "INSERT INTO `".$transportDb."`.`tbl_delivery` VALUES(null,'$newItemId','$sellerCompanyAddress','$buyerAddress',null,null,'$buyerCompanyName','$sellerCompanyName','pending','$buyerPhone1','$buyerPhone2','$purchaserName',null,null,CURRENT_TIMESTAMP)";
                                                $exec9 = mysqli_query($cont,$qry9);
                                                if($exec9){
                                                    $qry10 = "INSERT INTO tbl_transaction VALUES(null,'$newItemId','$medicineName','$quantity','$strength','$dosageForm','$batchNumber','$expiryDate','$MAId','$sellerCompanyType','$sellerCompanyName','$sellerCompanyId','$soldBy',CURRENT_TIMESTAMP,'$buyerCompanyType','$buyerCompanyName','$buyercompanyId','$purchaserName','$transportName')";
