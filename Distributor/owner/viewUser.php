...
<head>
    ...
    <title>View User | Owner | Distributor</title>
...
<body>
    ...
    <div class="container">     
        <h2 class="text-center">View User</h2>
            ...
            <?php
            $userId = $_POST['userId'];
                $userInfo="SELECT * FROM tbl_userInfo WHERE userId='$userId' ";
               $result=mysqli_query($con,$userInfo);
                ...
                $userContact="SELECT * FROM tbl_userContact WHERE userId=$userId ";
                ...
                $login="SELECT * FROM tbl_login WHERE userId=$userId ";
                ...
                $userAccount="SELECT * FROM tbl_userAccount WHERE userId=$userId ";
