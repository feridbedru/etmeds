...
<head>
    ...
    <title>Item Pickup | Driver | Transport</title>
...
<body>
    ...
    <div class="container">     
        <h2 class="text-center">Item Pickup</h2>
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Item Pickup</li>
            </ul>
            ...
            if($dbItemId == $itemId){
            $sql = "UPDATE tbl_delivery SET pickedDate=CURRENT_TIMESTAMP, status='picked up' WHERE deliveryId='$deliveryId'";
            $result = mysqli_query($conx,$sql);
            if($result){
                $sql2 = "INSERT INTO tbl_transportTransaction VALUES (null,'$itemId','$sellerCompany','$buyerCompany','$pickupAddress','$deliveryAddress',CURRENT_TIMESTAMP,'$transportName','$transportId','$driverName','$vehicle','picked up')";
                $result2 = mysqli_query($con,$sql2);
                if($result2){
                    echo('
                    <div class="jumbotron bg-white">
                        <h1 class="text-center text-success">Successful.</h1>
                        <p class="text-center">You have picked up an item.</p>
                    </div>
                ');
                }
                else{
