...
<head>
    ...
    <title>Approve Employee | Owner | Transport</title>
    ...
    <div class="container">     
        ...
        if ($result) {
            ...
            if($update2){
                ...
                if($result3){
                    $message = 'You have approved an employee request for '.$name.' with position of '.$role.' in your company';
                    $sql4 = "INSERT INTO tbl_notification VALUES (null,'$username','$userId','$message',CURRENT_TIMESTAMP,'$username','$userId',null,'unread','approved')";
