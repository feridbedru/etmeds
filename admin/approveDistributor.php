...
<head>
    ...
    <title>Distributor Approval | Admin | Et-Meds</title>
...
<body>
    ...
    <div class="container">     
        <h2 class="text-center">Distributor Approval</h2> 
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item"><a href="company.php">Company</a></li>
                <li class="breadcrumb-item active">Distributor Approval </li>
            </ul>
<?php
            ...
            if($result){    
                ...
                if($result2){
                    ...
                    if($result3){
                        ...
                        if($result4){
                            $sql5 = "
                            CREATE TABLE `".$db."`.`tbl_pendingStock` (
                                `pendingId` int(15) NULL AUTO_INCREMENT PRIMARY KEY,
