...
<head>
    ...
    <title><?php $companyType=$_POST["companyType"]; $role=$_POST["role"]; echo $companyType."&nbsp;".$role; ?>  | Admin | Et-Meds</title>
...
<body>
    ...
    $role=$_POST["role"];
        echo '<h2 class="text-center">'.$companyType.' '.$role.'\'s</h2><hr>';
        $sql = "SELECT * FROM tbl_login WHERE companyType='$companyType' AND userRole='$role'";
            $result = mysqli_query($con,$sql);
            $count = mysqli_num_rows($result);
            if($count>'0'){
                $sql = "SELECT * FROM tbl_login INNER JOIN tbl_userInfo ON tbl_userInfo.userId = tbl_login.userId WHERE companyType='$companyType' AND userRole='$role'  ORDER BY firstName ASC";
        ...
        $k++;
           ...
           echo(' </div>');
                ...
                <div class="jumbotron">
                    ...
                    <p class="text-center">We can not find any '.$companyType.' '.$role.'.</p>
                </div>
                ');
            }
