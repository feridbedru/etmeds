...
<head>
    ...
    <title>Profile | Owner | Warehouse</title>
    ...
    <div class="container">     
        <h2 class="text-center">Your Profile</h2>
            ...
            <?php
                ...
                global $security1, $security2, $security3;
                while ($row = mysqli_fetch_array($result)) {
                ...
                if($status=="error"){
                    ...
                    <div class="container">
                        ...
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <h5 class="text-center">An error occured while making changes. Please try again.</h5>
                        </div>
                        ';
                }
                    ...
                    <div class="container">
                        <div class="alert alert-danger alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <h5 class="text-center">Incorrect old password entered.</h5>
                        </div>
                        ';
                }
                else if($status=="pass"){
                    ...
                    <div class="container">
                        ...
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <h5 class="text-center">You have changed your password successfully.</h5>
                        </div>
                        ';
                }
            }
...
<div class="modal animate" id="basicModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <section class="pt-4 pb-4 clean-block clean-form dark ">
            <div class="container">
      ...
      <section class="pt-4 pb-4 clean-block clean-form dark ">
            <div class="container">
                <form name="login-detail" method="POST" action="updateSecurity.php">
                    ...
                    <select class="form-group" name="security1">
                    ...
                    <select class="form-group" name="security2">
                        <option>Choose one</option>
                        <option value="What was your first pet name?">What was your first pet name?</option>
                        <option value="What was your first car name?">What was your first car name?</option>
                        <option value="What was your first bike name?">What was your first bike name?</option>
                    ...
                    <select class="form-group" name="security3">
                        <option>Choose one</option>
                        <option value="What was your first pet name?">What was your first pet name?</option>
                        <option value="What was your first car name?">What was your first car name?</option>
                        <option value="What was your first bike name?">What was your first bike name?</option>
    ...
    <div class="modal-content">
      ...
      <section class="pt-4 pb-4 clean-block clean-form dark ">
            <div class="container">
                ...
                <div class="form-group"><label for="oldPassword">Old Password</label><input class="form-control item" type="password" name="oldPassword" id="oldPassword"></div>
                    <div class="form-group"><label for="newPassword">New Password</label><input class="form-control item" type="password" name="newPassword" id="newPassword"></div>
