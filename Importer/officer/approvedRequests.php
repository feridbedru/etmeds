...
<head>
    ...
    <title>Approved Request | Officer | Importer</title>
...
<body>
    ...
    <div class="container">     
        <h2 class="text-center">Approved Request</h2>
            <ul class="breadcrumb">
            ...
            <?php
                $sql = "SELECT * FROM tbl_request WHERE applicantId='".$sId."' AND status='approved' ORDER BY applicationDate DESC";
