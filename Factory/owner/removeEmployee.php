...
<head>
    ...
    <title>Remove Employee | Owner | Factory</title>
...
<body>
    ...
    <div class="container">     
        <h2 class="text-center">Remove Employee</h2>
            ...
            $userId = $_POST["userId"];
            $stat = "UPDATE tbl_employee SET employeeStatus='past', endDate=CURRENT_DATE WHERE employeeId='$employeeId' AND userId='$userId'";
