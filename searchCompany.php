...
<head>
    ...
    <title>Search Result | Et-Meds</title>
...
<body>
    ...
    <div class="container">
        ...
        echo '<h2 class="text-center"> You searched for '.$companyName.' </h2><hr>';
        $sql = "SELECT * FROM tbl_companyList WHERE status='active' AND companyName='$companyName'";
