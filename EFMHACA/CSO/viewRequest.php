...
<head>
    ...
    <title>View Request | CSO | EFMHACA</title>
...
<body>
    ...
    <div class="container">     
        ...
        <div class="clearfix">
            ...
            <div class="float-left">
                <h5>Document</h5>
                <a href="viewDocument.php?id=<?php echo $applicationNumber?>&type=documents" target="_blank"><button class="btn btn-primary">View Document</button></a>
            </div>
        </div><hr>
        <div class="clearfix">
            <div class="float-left mx-1">
            ...
            <div class="float-left">
                ...
                <a href="viewDocument.php?id=<?php echo $applicationNumber?>&type=applicationForm" target="_blank"><button class="btn btn-primary">View Document</button></a>
            </div>
        </div><hr>
        <div class="clearfix">
            <div class="float-left mx-1">
            ...
            <div class="float-left">
                <h5>Agreement</h5>
                <a href="viewDocument.php?id=<?php echo $applicationNumber?>&type=agreement" target="_blank"><button class="btn btn-primary">View Document</button></a>                
            </div>
        </div><hr>
        <?php
        if($status == "pending"){
            ...
            <center><button class="btn btn-primary" data-toggle="modal" data-target="#acceptRequestModal">Accept</button> &nbsp; &nbsp; &nbsp;
...
<div class="modal animate" id="acceptRequestModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="acceptRequest.php" class="form" method="POST">
        <p> The request application is now about to submitted to the CEO for final approval.</p>
        <div class="form-group"><label for="approvalComment">Comment</label><textarea class="form-control item" name="approvalComment" id="approvalComment" placeholder="Provide approval comment for further proessing."></textarea></div>
