...
<head>
    ...
    <title>Request | CSO | EFMHACA</title>
...
<body>
    ...
    <div class="container">     
        <h2 class="text-center">Request</h2>
            ...
            <a href="rejectedRequest.php"><button class="btn btn-large btn-success">Rejected Requests 
            <?php
            ...
            <?php
                $sql = "SELECT * FROM tbl_request WHERE status='pending'";
                $result = mysqli_query($conz,$sql);
                $count = mysqli_num_rows($result);
                if($count=='0'){
                    echo ('
